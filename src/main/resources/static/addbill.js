  ...
  if (!splitEnabled) {
    ...
    fetch('http://localhost:8081/api/expenses', {
      ...
      body: JSON.stringify({
          ...
          title: personalBill.title,

          amount: personalBill.amount,

          category: personalBill.category,

          expenseDate: personalBill.date,

          createdBy: personalBill.createdBy,
